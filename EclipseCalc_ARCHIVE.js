...
/*
 * Class holding dates in either 
 * a Date Object or string
 * Always returns null when empty.
 * Returns Date from Date object or properly formated string. 
 * @type type
 */
class QuasiDate
{
    constructor(date)
    {
        ...
        this.setDate = function(date)
        {
            if(date)
            {
                ...
                {
                    if(date !== "" && date !== "Inavlid Date" && date !== "null" )
                    {
                        m_date = date;
                    }
                }
        ...
        this.getDate = function()
        {
            if(m_date)
            {
                if(typeof(m_date) === "string")
                {
                    if(m_date !== "" || m_date !== "Invalid Date" || m_date !== "null")
                    {
                        return new Date(m_date);
                    }
                    return null;
                }
                else if(typeof(m_date) === "number")
                {
                    if(m_date !== 0)
                    {
                        var date = new Date();
                ...
                else if(typeof(m_date.getTime) === "function")
                {
                    if(isNaN(m_date.getTime()))
                    {
                        return null;
                    }
                    return m_date;
        ...
        this.toJSON = function()
        {
            if(m_date)
            {
                if(typeof(m_date.getTime) === "function")
                {
                    if(!isNaN(m_date.getTime()))
                    {
...
class CircumstanceDates
{
     ...
     */
    constructor(circumstances)
    {
        this.c1Date = new QuasiDate;
        this.c2Date = new QuasiDate;
        this.midDate = new QuasiDate;
        this.c3Date = new QuasiDate;
        this.c4Date = new QuasiDate;
        
        if(typeof(circumstances) === 'object')
        {
            if(circumstances !== null)
            {
                this.c1Date.setDate(circumstances.c1Date);
                this.c2Date.setDate(circumstances.c2Date);
                this.midDate.setDate(circumstances.midDate);
                this.c3Date.setDate(circumstances.c3Date);
                this.c4Date.setDate(circumstances.c4Date);                
            }
        }
    }    
    ...
    setC1Date(date)
    {
        this.c1Date.setDate(date);
    }
    
    setC2Date(date)
    {
        this.c2Date.setDate(date);
    }
    
    setMidDate(date)
    {
        this.midDate.setDate(date);
    }
    
    setC3Date(date)
    {
       this.c3Date.setDate(date);
    }
    
    setC4Date(date)
    {
        this.c4Date.setDate(date);            
    }
    
    getC1Date()
    {
       return this.c1Date.getDate();
    }
    
    getC2Date()
    {
       return this.c2Date.getDate();
    }
    
    getMidDate()
    {
        return this.midDate.getDate();        
    }
    
    getC3Date()
    {
       return this.c3Date.getDate();
    }
    
    getC4Date()
    {
        return this.c4Date.getDate();       
    }    
}
...
// How many westerly degrees seperate out the two values
    ...
    */
    ...
    {
        this.northUmbraLineTimes = times;       
    };
    ...
    {
        this.southUmbraLineTimes = times;
    };
    ...
    {
        this.westPenumbraLineTimes = times;
    };
    ...
    {
        this.eastPenumbraLineTimes = times;
    };
