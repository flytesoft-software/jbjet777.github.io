...
class AnimateWorker
{
    constructor()
    {
        ...
        function drawShadow(msg)    
        {
            var animateTime = parseFloat(msg);
            
            var penumbraShadow = createArc(mEclipse.drawPenumbraShadow(animateTime));
...
(function() 
{
    console.log("ANIMATE WORKER: Initialized.");
    
    var animateWorker = new AnimateWorker;
})();
